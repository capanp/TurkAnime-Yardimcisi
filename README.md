Türk anime izleme platformlarını geliştiren tarayıcı eklentisi.

**Ne İşe Yarar**
- Sizi uğraştırmadan içeriği seçer.
- Kaydedilmiş çevirmenleri sırasına göre seçer.
- Kaydedilmiş oynatıcıları sırasına göre seçer.
- Bir sonraki bölüme geçmek için klavye tuşu kısayolu "-, +".

[Google uzantı indirme linki](https://chromewebstore.google.com/detail/t%C3%BCrkanime-yard%C4%B1mc%C4%B1s%C4%B1/iebihkhjnleedpmpdpcplimgjbodmjec)

**Desteklenen siteler**
- [Open Anime](https://openani.me/)
